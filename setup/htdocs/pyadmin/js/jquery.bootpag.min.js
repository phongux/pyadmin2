...
(function(h, q) {
    h.fn.bootpag = function(p) {
        ...
        return this.each(function() {
            ...
            a.firstLastUse && (c = c.concat(['<li data-lp="1" class="', a.firstClass, ' page-item"><a class="page-link" href="', g(1), '">', a.first, "</a></li>"]));
            a.prev && (c = c.concat(['<li data-lp="1" class="', a.prevClass, ' page-item"><a class="page-link" href="', g(1), '">', a.prev, "</a></li>"]));
            for (b = 1; b <= Math.min(a.total, a.maxVisible); b++)
                c = c.concat(['<li class="page-item" data-lp="', b, '"><a  class="page-link" href="', g(b), '">', b, "</a></li>"]);
            a.next && (b = a.leaps && a.total > a.maxVisible ? Math.min(a.maxVisible + 1, a.total) : 2,
            c = c.concat(['<li data-lp="', b, '" class="', a.nextClass, ' page-item"><a class="page-link" href="', g(b), '">', a.next, "</a></li>"]));
            a.firstLastUse && (c = c.concat(['<li data-lp="', a.total, '" class="last page-item"><a class="page-link" href="', g(a.total), '">', a.last, "</a></li>"]));
            c.push("</ul>");
