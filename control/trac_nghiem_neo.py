...
def application(environment, start_response):
    ...
    if 'username' not in session:
        ...
        if int(ps[0][2]) > 0:
            ...
            saveurl = f"""'{save}/save_trac_nghiem_neo'"""
            loadurl = f"""'{load}/load_trac_nghiem_neo'"""
            page = ""
            page += head
            ...
            page += f"""
				...
				<p> Hướng dẫn: tích lựa chọn trong cột trả lời. Chú ý phải trả lời hết tất cả các câu. Sau đó chọn xem kết quả ở menu </p>
                <br />
        <p>
